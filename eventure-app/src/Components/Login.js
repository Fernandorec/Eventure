...
export function Login() {
  return (
    ...
    >
      <div style={{ display: 'flex', backgroundColor: 'rgba(255, 255, 255, 0.2)', borderRadius: '20px', boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.1)', overflow: 'hidden' }}>
        ...
        >
          ...
          <form style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <div className='IDredondear' style={{ marginBottom: '10px', textAlign: 'center' }}>
              {/* AQUÍ ESTABA LA IMAGEN QUE ELIMINÉ */}
              {/* <img src={usuarioImg} alt="Usuario" style={{ marginRight: '10px', width: '24px', height: '24px' }} /> */}
